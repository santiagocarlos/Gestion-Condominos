	...
	<div class="container-fluid spark-screen">
	 <div class="row">
      <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ route('admin.towers.update', $tower->tower_id) }}" method="POST">
              {!! csrf_field() !!}
              {!! method_field('PUT') !!}
              <div class="box-body">
                <div class="form-group">
                  <label for="name-tower">Ingresa el nombre de la torre</label>
                  <input type="text" class="form-control" name="tower" id="name-tower" value="{{ $tower->tower_name or old('tower') }}" placeholder="Nombre">
                    <div class="errors">
                      {{ $errors->first('tower') }}
                    </div>
                </div>
