...
@section('main-content')
   ...
   <div class="row">
      <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ route('admin.news.update', $notice->id) }}" method="POST">
              {!! csrf_field() !!}
              {!! method_field('PUT') !!}
              <div class="box-body">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" value="{{ $notice->title or old('title') }}" placeholder="Título de la Noticia">
                      <div class="errors">
                        {{ $errors->first('title') }}
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    @else
                      <select class="form-control" name="category_id">
                        <option value="{{ $notice->category_id }}">{{ $category->name }}</option>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="ckeditor" name="description" rows="10" cols="80">{!! $notice->description !!}</textarea>
                      <div class="errors">
