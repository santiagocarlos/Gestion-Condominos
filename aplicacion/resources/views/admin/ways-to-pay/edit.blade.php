...
@section('main-content')
   ...
   <div class="row">
      <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="{{ route('admin.ways-to-pay.update', $way->id) }}" method="POST">
              {!! csrf_field() !!}
              {!! method_field('PUT') !!}
              <div class="box-body">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="name" id="name" value="{{ $way->name }}" placeholder="Nombre">
                      <div class="errors">
                        {{ $errors->first('name') }}
                      </div>
                  </div>
