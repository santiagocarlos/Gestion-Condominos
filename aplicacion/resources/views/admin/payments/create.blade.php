     ...
     <div class="box box-default">
      ...
      <div class="box-body">
         <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="row">
               <div class="box-body">
                <form action="{{ route('admin.payments.store') }}" method="POST" class="form-group" enctype="multipart/form-data">
                {!! csrf_field() !!}
                <div class="row">
                  <div class="col-md-6 form-group">
                    <label>Propietario</label>
                    <input type="text" class="form-control" readonly value="{{ $owner->namePeople }} {{ $owner->last_name }}">
                  </div>
                  <div class="col-md-6 form-group">
                    <label>Torre-Piso-Apartamento</label>
                    <input type="text" class="form-control" readonly value="{{ $owner->nameTower }}-{{ $owner->floor }}-{{ $owner->apartment }}">
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-12 form-group">
                      <div class="alert alert-info">
                        <p>
                          <center>
                          <strong>Estás solvente <span class="fa fa-check"></span></strong> <br> No tienes recibos pendientes por pagar. <br>
                          </center>
                        </p>
                      </div>
                  </div>
